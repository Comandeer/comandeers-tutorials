...
[code=javascript]formatter.format( new Date() ); // 23.7.2016[/code]
...
formatter.format( new Date() ); // 23 lipca 2016[/code]
[p][i]Voila![/i] To jest dokładnie to, o co nam chodziło. Oczywiście opcji jest więcej, po dokładny ich spis [url=https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters]zapraszam na MDN[/url].[/p]
