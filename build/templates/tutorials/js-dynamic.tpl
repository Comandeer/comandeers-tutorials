...
[code=javascript]function __autoload($name)
{
...
[p]Ten problem postanowiono rozwiązać w sposób kulturalny i jakoś go ustandaryzować. Tak powstało [url=https://github.com/amdjs/amdjs-api/wiki/AMD]Asynchrounous Module Definition[/url], na które składają się de facto dwie funkcje - [tt]define[/tt] i [tt]require[/tt][/p]
...
[h2="es6"]Przyszłość - ES6 Modules[/h2]
