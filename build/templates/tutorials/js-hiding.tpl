...
[code=javascript]var g = function(r) {console.log(r);};
...
[p]Zatem gdy trochę się wysili szare komórki, można dojść do pewnego uogólnienia, że w bardzo zaowalowany sposób po prostu wywołujemy [tt]Function.prototype.bind[/tt] ;)[/p]
...
[code=javascript]var obfuscate = function(f)
{
	return Function.prototype.call.apply(Function.prototype.bind, [f]);
}[/code]
...
{}[/code]
[p]Dobra, zwracanie niezaciemnionego kodu jest łatwe - wystarczy zwrócić parametr [tt]f[/tt]. Tyle. Zatem po połączeniu wszystkiego razem, otrzymamy coś takiego:[/p]
[code=javascript]var obfuscate = (function()
{
...
[*] sprawdzamy czy obfuskacja wgl działa w bloku [tt]try[/tt]/[tt]catch[/tt]. jeśli nie, jak gdyby nigdy nic, zwracamy funkcję zwracającą parametr [tt]f[/tt] (nieźle to brzmi ;))
...
[p]Aaaaa, i taka uwaga na koniec: moja funkcja [tt]obfuscate[/tt] bardzo lubi strict mode :D[/p]
