...
[/list]
[p]Jeżeli powyższe informacje nie są dla Ciebie wystarczające, poniżej znajdziesz szczegóły.[/p]

[h2="dane-osobowe"]Dane osobowe[/h2]
[p][b]Administratorem[/b] Twoich danych osobowych w rozumieniu przepisów o ochronie danych osobowych jest Tomasz Jakut.[/p]
[p][b]Cele, podstawy prawne oraz okres przetwarzania danych osobowych[/b] wskazane są odrębnie w stosunku do każdego celu przetwarzania danych (patrz: opis poszczególnych celów przetwarzania danych osobowych poniżej).[/p]

[h3="uprawnienia"]Uprawnienia[/h3]
...
[h2="pliki-cookies-i-inne-technologie-sledzace"]Pliki cookies i inne technologie śledzące[/h2]
[p]Moja strona, podobnie jak niemal wszystkie inne strony internetowe, wykorzystuje pliki cookies, by zapewnić Ci najlepsze doświadczenia związane z korzystaniem z niej.[/p]
...
[h3="zgoda-na-cookies"]Zgoda na cookies[/h3]
...
[h3="cookies-wlasne"]Cookies własne[/h3]
[p]Cookies własne wykorzystuję w celu zapewnienia prawidłowego działania strony, w szczególności w celu dostosowania layoutu strony do Twoich preferencji.[/p]

[h3="cookies-podmiotow-trzecich"]Cookies podmiotów trzecich[/h3]
[p]Moja strona, podobnie jak większość współczesnych stron internetowych, wykorzystuje funkcje zapewniane przez podmioty trzecie, co wiąże się z wykorzystywaniem plików cookies pochodzących od podmiotów trzecich. Wykorzystanie tego rodzaju plików cookies zostało opisane poniżej.[/p]

[h4="analiza-i-statystyka"]Analiza i statystyka[/h4]
[p]Wykorzystuję cookies do śledzenia statystyk strony, takich jak liczba osób odwiedzających, rodzaj systemu operacyjnego i przeglądarki internetowej wykorzystywanej do przeglądania strony, czas spędzony na stronie, odwiedzone podstrony etc. Korzystam w tym zakresie z Google Analytics, co wiąże się z wykorzystaniem plików cookies firmy Google LLC.[/p]
